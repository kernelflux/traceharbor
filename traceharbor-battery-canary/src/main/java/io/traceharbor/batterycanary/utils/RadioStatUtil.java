...
public final class RadioStatUtil {
    private static final String TAG = "TraceHarbor.battery.ProcStatUtil";
    ...
    public static RadioStat getCurrentStat(Context context) {
        ...
        try {
            ...
            TraceHarborLog.w(TAG, "querySummary fail: " + e.getMessage());
            sLastRef = null;
            return null;
        }
    }
    ...
    public static RadioBps getCurrentBps(Context context) {
        ...
        try {
            ...
            TraceHarborLog.w(TAG, "getBps err: " + e.getMessage());
            return null;
        }
    }

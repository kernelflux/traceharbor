...
import io.traceharbor.batterycanary.monitor.BatteryMonitorCore.Callback;
...
public final class JiffiesMonitorFeature extends AbsMonitorFeature {
    private static final String TAG = "TraceHarbor.battery.JiffiesMonitorFeature";
    ...
    public static class ProcessInfo {
        static ProcessInfo getProcessInfo() {
            ...
            processInfo.name = TraceHarbor.isInstalled() ? TraceHarborUtil.getProcessName(TraceHarbor.with().getApplication()) : "default";
                    ...
                    if (taskDir.isDirectory()) {
                        ...
                        for (File file : subDirs) {
                            ...
                            try {
                                ...
                                TraceHarborLog.printErrStackTrace(TAG, e, "parse thread error: " + file.getName());
                            }
                        }
    ...
    class ThreadWatchDog implements Runnable {
        ...
        public void run() {
            // watch
            TraceHarborLog.i(TAG, "threadWatchDog start, size = " + mWatchingThreads.size()
        ...
        void start() {
            synchronized (mWatchingThreads) {
                ...
                if (!mWatchingThreads.isEmpty()) {
                    HandlerThread handlerThread = new HandlerThread("traceharbor_watchdog");
                    handlerThread.start();

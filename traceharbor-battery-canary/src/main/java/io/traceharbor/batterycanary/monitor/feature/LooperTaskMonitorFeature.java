...
import io.traceharbor.batterycanary.BuildConfig;
...
public final class LooperTaskMonitorFeature extends AbsTaskMonitorFeature {
    private static final String TAG = "TraceHarbor.battery.LooperTaskMonitorFeature";
        ...
        mLooperTaskListener = new ILooperListener() {
            ...
            public void onDispatchBegin(String x) {
                if (mCore.getConfig().isAggressiveMode) {
                    TraceHarborLog.i(TAG, "[" + Thread.currentThread().getName() + "]" + x);
                }
            ...
            // <<<<< Finished to Handler (android.os.Handler) {5774ba9} null
            // >>>>> Dispatching to Handler (android.os.Handler) {5774ba9} io.traceharbor.batterycanary.monitor.feature.MonitorFeatureLooperTest$6$1@a8ee52e: 0
            // <<<<< Finished to Handler (android.os.Handler) {5774ba9} io.traceharbor.batterycanary.monitor.feature.MonitorFeatureLooperTest$6$1@a8ee52e

...
import static io.traceharbor.batterycanary.monitor.BatteryMonitorConfig.DEF_STAMP_OVERHEAT;

@SuppressWarnings("NotNullFieldNotInitialized")
public abstract class AbsTaskMonitorFeature extends AbsMonitorFeature {
    private static final String TAG = "TraceHarbor.battery.AbsTaskMonitorFeature";
    ...
    protected void updateDeltas(TaskJiffiesSnapshot bgn, TaskJiffiesSnapshot end) {
        ...
        TraceHarborLog.i(TAG, "onTaskReport: %s, jiffies = %s, millis = %s", delta.dlt.name, delta.dlt.jiffies.get(), delta.during);

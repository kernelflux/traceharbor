...
import io.traceharbor.batterycanary.utils.LocationManagerServiceHooker;
import io.traceharbor.util.TraceHarborLog;

import androidx.annotation.NonNull;

public final class LocationMonitorFeature extends AbsMonitorFeature {
    private static final String TAG = "TraceHarbor.battery.LocationMonitorFeature";
        ...
        if (mCore.getConfig().isAmsHookEnabled) {
            mListener = new LocationManagerServiceHooker.IListener() {
                ...
                public void onRequestLocationUpdates(long minTimeMillis, float minDistance) {
                    ...
                    TraceHarborLog.i(TAG, "#onRequestLocationUpdates, time = " + minTimeMillis + ", distance = " + minDistance + ", stack = " + stack);

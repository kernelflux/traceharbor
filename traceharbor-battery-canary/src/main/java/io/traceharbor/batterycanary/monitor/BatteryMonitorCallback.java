package io.traceharbor.batterycanary.monitor;

import android.content.ComponentName;
import android.os.SystemClock;
import android.text.TextUtils;

import io.traceharbor.batterycanary.monitor.feature.AbsTaskMonitorFeature.TaskJiffiesSnapshot;
import io.traceharbor.batterycanary.monitor.feature.AlarmMonitorFeature;
import io.traceharbor.batterycanary.monitor.feature.AlarmMonitorFeature.AlarmSnapshot;
import io.traceharbor.batterycanary.monitor.feature.AppStatMonitorFeature;
import io.traceharbor.batterycanary.monitor.feature.BlueToothMonitorFeature.BlueToothSnapshot;
import io.traceharbor.batterycanary.monitor.feature.CompositeMonitors;
import io.traceharbor.batterycanary.monitor.feature.CpuStatFeature;
import io.traceharbor.batterycanary.monitor.feature.CpuStatFeature.CpuStateSnapshot;
import io.traceharbor.batterycanary.monitor.feature.DeviceStatMonitorFeature.BatteryTmpSnapshot;
import io.traceharbor.batterycanary.monitor.feature.DeviceStatMonitorFeature.CpuFreqSnapshot;
import io.traceharbor.batterycanary.monitor.feature.InternalMonitorFeature;
import io.traceharbor.batterycanary.monitor.feature.JiffiesMonitorFeature;
import io.traceharbor.batterycanary.monitor.feature.JiffiesMonitorFeature.JiffiesSnapshot;
import io.traceharbor.batterycanary.monitor.feature.JiffiesMonitorFeature.JiffiesSnapshot.ThreadJiffiesEntry;
import io.traceharbor.batterycanary.monitor.feature.LocationMonitorFeature.LocationSnapshot;
import io.traceharbor.batterycanary.monitor.feature.LooperTaskMonitorFeature;
import io.traceharbor.batterycanary.monitor.feature.MonitorFeature.Snapshot.Delta;
import io.traceharbor.batterycanary.monitor.feature.MonitorFeature.Snapshot.Entry.BeanEntry;
import io.traceharbor.batterycanary.monitor.feature.MonitorFeature.Snapshot.Entry.DigitEntry;
import io.traceharbor.batterycanary.monitor.feature.MonitorFeature.Snapshot.Entry.ListEntry;
import io.traceharbor.batterycanary.monitor.feature.MonitorFeature.Snapshot.Sampler;
import io.traceharbor.batterycanary.monitor.feature.NotificationMonitorFeature;
import io.traceharbor.batterycanary.monitor.feature.NotificationMonitorFeature.BadNotification;
import io.traceharbor.batterycanary.monitor.feature.WakeLockMonitorFeature;
import io.traceharbor.batterycanary.monitor.feature.WakeLockMonitorFeature.WakeLockSnapshot;
import io.traceharbor.batterycanary.monitor.feature.WakeLockMonitorFeature.WakeLockTrace.WakeLockRecord;
import io.traceharbor.batterycanary.monitor.feature.WifiMonitorFeature.WifiSnapshot;
import io.traceharbor.batterycanary.stats.BatteryStatsFeature;
import io.traceharbor.batterycanary.utils.BatteryCanaryUtil;
import io.traceharbor.batterycanary.utils.Consumer;
import io.traceharbor.batterycanary.utils.PowerProfile;
...
public interface BatteryMonitorCallback extends
    ...
    class BatteryPrinter implements BatteryMonitorCallback {
        private static final String TAG = "TraceHarbor.battery.BatteryPrinter";
                                    ...
                                    public void accept(JiffiesMonitorFeature feature) {
                                        ...
                                        if (appStats.isForeground()) {
                                            if (minute > 10 && avgJiffies > getMonitor().getConfig().fgThreadWatchingLimit) {
                                                TraceHarborLog.i(TAG, "threadWatchDog fg set, name = " + delta.dlt.name
                                                        + ", pid = " + delta.dlt.pid
                                            ...
                                            if (minute > 10 && avgJiffies > getMonitor().getConfig().bgThreadWatchingLimit) {
                                                TraceHarborLog.i(TAG, "threadWatchDog bg set, name = " + delta.dlt.name
                                                        + ", pid = " + delta.dlt.pid
                                                        + ", tid = " + threadJiffies.tid);

...
import static io.traceharbor.batterycanary.utils.BatteryCanaryUtil.ONE_MIN;
...
public final class BatteryEventDelegate {
    public static final String TAG = "TraceHarbor.battery.LifeCycle";
    ...
    void dispatchSateChangedEvent(Intent intent) {
        TraceHarborLog.i(TAG, "onSateChanged >> " + intent.getAction());
        synchronized (mListenerList) {

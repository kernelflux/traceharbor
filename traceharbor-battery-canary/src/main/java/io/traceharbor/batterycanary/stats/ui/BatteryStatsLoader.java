...
import io.traceharbor.batterycanary.stats.BatteryStatsFeature.BatteryRecords;
import io.traceharbor.batterycanary.stats.ui.BatteryStatsAdapter.Item;
...
public class BatteryStatsLoader {
    private static final String TAG = "TraceHarbor.battery.loader";

package io.traceharbor.batterycanary.shell;
...
import io.traceharbor.batterycanary.monitor.BatteryMonitorCallback.BatteryPrinter.Printer;
import io.traceharbor.batterycanary.monitor.feature.AbsMonitorFeature;
...
public class TopThreadFeature extends AbsMonitorFeature {
    private static final String TAG = "TraceHarbor.battery.TopThread";
    ...
    public void top(final int seconds, final Supplier<CompositeMonitors> supplier, final ContinuousCallback callback) {
        ...
        HandlerThread thread = new HandlerThread("traceharbor_top");
        thread.start();

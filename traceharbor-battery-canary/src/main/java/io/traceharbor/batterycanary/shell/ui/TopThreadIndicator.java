package io.traceharbor.batterycanary.shell.ui;
...
import io.traceharbor.batterycanary.BatteryCanary;
import io.traceharbor.batterycanary.R;
...
import io.traceharbor.batterycanary.monitor.feature.MonitorFeature.Snapshot.Sampler.Result;
import io.traceharbor.batterycanary.monitor.feature.TrafficMonitorFeature;
import io.traceharbor.batterycanary.shell.TopThreadFeature;
import io.traceharbor.batterycanary.shell.TopThreadFeature.ContinuousCallback;
...
import io.traceharbor.batterycanary.stats.ui.BatteryStatsActivity;
import io.traceharbor.batterycanary.utils.BatteryCanaryUtil;
import io.traceharbor.batterycanary.utils.CallStackCollector;
...
import static io.traceharbor.batterycanary.shell.TopThreadFeature.figureCupLoad;
import static io.traceharbor.batterycanary.shell.TopThreadFeature.fixedColumn;
import static io.traceharbor.batterycanary.shell.TopThreadFeature.formatFloat;
...
final public class TopThreadIndicator {
    private static final String TAG = "TraceHarbor.TopThreadIndicator";
    ...
    public boolean show(Context context) {
        ...
        try {
            ...
            TraceHarborLog.w(TAG, "Create float view failed:" + e.getMessage());
            return false;
        }
    }

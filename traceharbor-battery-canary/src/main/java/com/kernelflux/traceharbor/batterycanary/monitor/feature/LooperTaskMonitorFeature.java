...
public final class LooperTaskMonitorFeature extends AbsTaskMonitorFeature {
    ...
    public void onTurnOn() {
        ...
        mLooperTaskListener = new ILooperListener() {
            ...
            // <<<<< Finished to Handler (android.os.Handler) {5774ba9} null
            // >>>>> Dispatching to Handler (android.os.Handler) {5774ba9} com.kernelflux.traceharbor.batterycanary.monitor.feature.MonitorFeatureLooperTest$6$1@a8ee52e: 0
            // <<<<< Finished to Handler (android.os.Handler) {5774ba9} com.kernelflux.traceharbor.batterycanary.monitor.feature.MonitorFeatureLooperTest$6$1@a8ee52e

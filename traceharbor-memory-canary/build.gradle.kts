...
android {
    ...
    compileOptions {
        // Kotlin 1.8+ no longer supports jvmTarget = "1.7"; raised to JDK 1.8
        // to match the rest of the project and silence the
        // "compileJavaWithJavac is 1.7 / compileKotlin is 17" mismatch.
...
val kotlinVersion = gradleExtra.get("KOTLIN_VERSION").toString()

package io.traceharbor.openglleak.statistics.resource;

import android.annotation.SuppressLint;

import io.traceharbor.openglleak.hook.OpenGLHook;
import io.traceharbor.openglleak.utils.AutoWrapBuilder;
...
public class ResRecordManager {
    private static final String TAG = "TraceHarbor.ResRecordManager";

...
import io.traceharbor.openglleak.detector.IOpenglIndexDetector;
import io.traceharbor.openglleak.detector.OpenglIndexDetectorService;
import io.traceharbor.openglleak.hook.OpenGLHook;
...
import io.traceharbor.openglleak.utils.EGLHelper;
import io.traceharbor.openglleak.utils.GlLeakHandlerThread;
...
public class OpenglLeakPlugin extends Plugin {
    ...
    private static final String TAG = "traceharbor.OpenglLeakPlugin";
...
//            OpenGLHook.getInstance().hook(FuncNameString.GL_BIND_FRAMEBUFFER, map.get(FuncNameString.GL_BIND_FRAMEBUFFER));
    ...
    private void startImpl() {
        ...
        try {
            ...
            TraceHarborLog.d(TAG, "bindService error = " + e.getCause());
        }

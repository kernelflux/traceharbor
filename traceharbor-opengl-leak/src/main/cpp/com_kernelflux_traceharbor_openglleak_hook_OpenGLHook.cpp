...
#include <EGL/egl.h>
#include <cxxabi.h>
#include "com_kernelflux_traceharbor_openglleak_hook_OpenGLHook.h"
#include <string>
#include "get_tls.h"
#include "type.h"
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_init
        (JNIEnv *env, jobject thiz) {
    if (class_OpenGLHook == NULL) {
        // 暂存 class, hook 处只能用 bootclassloader
        class_OpenGLHook = env->FindClass("com/kernelflux/traceharbor/openglleak/hook/OpenGLHook");
...
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_setNativeStackDump(JNIEnv *, jobject thiz,
                                                                      jboolean open) {
    enable_stacktrace(open);
}

extern "C" JNIEXPORT void JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_setJavaStackDump(JNIEnv *, jobject thiz,
                                                                    jboolean open) {
...
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookEgl(JNIEnv *env, jclass clazz) {
    ...
    xhook_grouped_ignore(HOOK_REQUEST_GROUPID_EGL_HOOK, ".*libtraceharbor-opengl-leak\\.so$", nullptr);
...
/*
 * Class:     com_kernelflux_traceharbor_openglleak_hook_OpenGLHook
 * Method:    hookGlGenTextures
 * Signature: (I)Z
 */
extern "C" JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlGenTextures
 ...
 */
extern "C" JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlDeleteTextures
        (JNIEnv *, jclass, jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
 ...
 */
extern "C" JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlGenBuffers
        (JNIEnv *, jclass, jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
 ...
 */
extern "C" JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlDeleteBuffers
        (JNIEnv *, jclass, jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
 ...
 */
extern "C" JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlGenFramebuffers
        (JNIEnv *, jclass, jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
 ...
 */
extern "C" JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlDeleteFramebuffers
        (JNIEnv *, jclass, jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
 ...
 */
extern "C" JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlGenRenderbuffers
        (JNIEnv *, jclass, jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
 ...
 */
extern "C" JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlDeleteRenderbuffers
        (JNIEnv *, jclass, jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
 ...
 */
extern "C" JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlGetError
        (JNIEnv *, jclass, jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlTexImage2D(JNIEnv *env, jclass clazz,
                                                                    jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlTexImage3D(JNIEnv *env, jclass clazz,
                                                                    jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlBindTexture(JNIEnv *env, jclass clazz,
                                                                     jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlBindBuffer(JNIEnv *env, jclass clazz,
                                                                    jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlBindFramebuffer(JNIEnv *env, jclass clazz,
                                                                         jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlBindRenderbuffer(JNIEnv *env, jclass clazz,
                                                                          jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlBufferData(JNIEnv *env, jclass clazz,
                                                                    jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return false;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_hookGlRenderbufferStorage(JNIEnv *env,
                                                                             jclass clazz,
                                                                             jint index) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
...
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_dumpNativeStack(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_dumpBriefNativeStack(JNIEnv *env, jclass clazz,
                                                                   jlong native_stack_ptr) {
    int64_t addr = native_stack_ptr;
    auto *ptr = (wechat_backtrace::Backtrace *) addr;
...
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_releaseNative(JNIEnv *env, jclass clazz,
                                                                 jlong native_stack_ptr) {
...
extern "C"
JNIEXPORT jboolean JNICALL Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_isEglSurfaceAlive(
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_isEglContextAlive(
...
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_getResidualQueueSize(JNIEnv *env,
                                                                        jobject clazz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_kernelflux_traceharbor_openglleak_hook_OpenGLHook_updateCurrActivity(JNIEnv *env, jobject thiz,

...
#include "com_kernelflux_traceharbor_openglleak_detector_FuncSeeker.h"
#include "get_tls.h"
#include "type.h"

#define HOOK_O_FUNC(func, params...) func(params)

#define LOG_TAG "traceharbor.opengl"
...
Java_com_kernelflux_traceharbor_openglleak_detector_FuncSeeker_getTargetFuncIndex(JNIEnv *env, jclass,
...
JNICALL Java_com_kernelflux_traceharbor_openglleak_detector_FuncSeeker_getGlGetErrorIndex
        (JNIEnv *, jclass) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return -1;
...
Java_com_kernelflux_traceharbor_openglleak_detector_FuncSeeker_getBindFuncIndex(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_kernelflux_traceharbor_openglleak_detector_FuncSeeker_getGlTexImage2DIndex(JNIEnv *env,
                                                                            jclass clazz) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return -1;
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_kernelflux_traceharbor_openglleak_detector_FuncSeeker_getGlTexImage3DIndex(JNIEnv *env, jclass clazz) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return -1;
    }
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_kernelflux_traceharbor_openglleak_detector_FuncSeeker_getGlBufferDataIndex(JNIEnv *env, jclass clazz) {
    gl_hooks_t *hooks = get_gl_hooks();
    if (NULL == hooks) {
        return -1;
    }
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_kernelflux_traceharbor_openglleak_detector_FuncSeeker_getGlRenderbufferStorageIndex(JNIEnv *env,
                                                                                     jclass clazz) {

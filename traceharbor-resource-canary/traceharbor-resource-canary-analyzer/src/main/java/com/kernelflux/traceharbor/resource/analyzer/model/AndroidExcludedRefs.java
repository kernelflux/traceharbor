...
import static com.kernelflux.traceharbor.resource.analyzer.utils.ManufacturerNames.HUAWEI;
import static com.kernelflux.traceharbor.resource.analyzer.utils.ManufacturerNames.LENOVO;
import static com.kernelflux.traceharbor.resource.analyzer.utils.ManufacturerNames.LG;
import static com.kernelflux.traceharbor.resource.analyzer.utils.ManufacturerNames.MEIZU;
import static com.kernelflux.traceharbor.resource.analyzer.utils.ManufacturerNames.MOTOROLA;
import static com.kernelflux.traceharbor.resource.analyzer.utils.ManufacturerNames.NVIDIA;
import static com.kernelflux.traceharbor.resource.analyzer.utils.ManufacturerNames.SAMSUNG;
 ...
 *
 * Most app developers should use {@link #createAppDefaults(int, String)}. However, you can also pick the
 * leaks you want to ignore by creating an {@link EnumSet} that matches your needs and calling
 * {@link #createBuilder(EnumSet, int, String)}
 */
...
public enum AndroidExcludedRefs {
    ...
    SPELL_CHECKER_SESSION() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return (sdkVersion >= VersionCodes.JELLY_BEAN && sdkVersion <= VersionCodes.LOLLIPOP_MR1) || sdkVersion >= VersionCodes.N;
        }
    ...
    INSTRUMENTATION_RECOMMEND_ACTIVITY() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return MEIZU.equals(manufacturer) && sdkVersion >= VersionCodes.LOLLIPOP && sdkVersion <= VersionCodes.LOLLIPOP_MR1;
        }
    ...
    DEVICE_POLICY_MANAGER__SETTINGS_OBSERVER() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return MOTOROLA.equals(manufacturer) && sdkVersion >= VersionCodes.KITKAT && sdkVersion <= VersionCodes.LOLLIPOP_MR1;
        }
    ...
    SPEN_GESTURE_MANAGER() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return SAMSUNG.equals(manufacturer) && sdkVersion == VersionCodes.KITKAT;
        }
    ...
    GESTURE_BOOST_MANAGER() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return HUAWEI.equals(manufacturer) && sdkVersion >= VersionCodes.N && sdkVersion <= VersionCodes.O;
        }
    ...
    CLIPBOARD_UI_MANAGER__SINSTANCE() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return SAMSUNG.equals(manufacturer) && sdkVersion >= VersionCodes.KITKAT && sdkVersion <= VersionCodes.LOLLIPOP;
        }
    ...
    SEM_CLIPBOARD_MANAGER__MCONTEXT() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return SAMSUNG.equals(manufacturer) && sdkVersion >= VersionCodes.KITKAT && sdkVersion <= VersionCodes.N;
        }

        @Override
        void add(ExcludedRefs.Builder excluded) {
            excluded.instanceField("com.samsung.android.content.clipboard.SemClipboardManager", "mContext")
    ...
    BUBBLE_POPUP_HELPER__SHELPER() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return LG.equals(manufacturer) && sdkVersion >= VersionCodes.KITKAT && sdkVersion <= VersionCodes.LOLLIPOP;
        }
    ...
    LGCONTEXT__MCONTEXT() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return LG.equals(manufacturer) && sdkVersion == VersionCodes.LOLLIPOP;
        }
    ...
    MAPPER_CLIENT() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return NVIDIA.equals(manufacturer) && sdkVersion == VersionCodes.KITKAT;
        }
    ...
    TEXT_VIEW__MLAST_HOVERED_VIEW() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return SAMSUNG.equals(manufacturer) && sdkVersion >= VersionCodes.KITKAT && sdkVersion <= VersionCodes.LOLLIPOP_MR1;
        }
    ...
    SYSTEM_SENSOR_MANAGER_LENOVO() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return LENOVO.equals(manufacturer) && sdkVersion == VersionCodes.KITKAT;
        }
    ...
    ACTIVITY_MANAGER_MCONTEXT() {
        @Override
        boolean accept(int sdkVersion, String manufacturer) {
            return SAMSUNG.equals(manufacturer) && sdkVersion == VersionCodes.LOLLIPOP_MR1;
        }
...
//    },
     ...
     */
    public static ExcludedRefs.Builder createAndroidDefaults(int sdkVersion, String manufacturer) {
        return createBuilder(
                EnumSet.of(SOFT_REFERENCES, FINALIZER_WATCHDOG_DAEMON, MAIN,
                        EVENT_RECEIVER__MMESSAGE_QUEUE), sdkVersion, manufacturer);
    }
     ...
     * developers except by resorting to serious hacks, so we remove the noise caused by those
     * leaks.
     */
    public static ExcludedRefs.Builder createAppDefaults(int sdkVersion, String manufacturer) {
        return createBuilder(EnumSet.allOf(AndroidExcludedRefs.class), sdkVersion, manufacturer);
    }

    public static ExcludedRefs.Builder createBuilder(EnumSet<AndroidExcludedRefs> refs, int sdkVersion, String manufacturer) {

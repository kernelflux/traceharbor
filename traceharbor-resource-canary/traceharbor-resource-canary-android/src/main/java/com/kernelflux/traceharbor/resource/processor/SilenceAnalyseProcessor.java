...
public class SilenceAnalyseProcessor extends BaseLeakProcessor {
    ...
    private static final String TAG = "TraceHarbor.LeakProcessor.SilenceAnalyse";
    ...
    private boolean onLeak(final String activity, final String refString) {
        TraceHarborLog.i(TAG, "[onLeak] activity=%s isScreenOff=%s isProcessing=%s", activity, isScreenOff, isProcessing);

package io.traceharbor.traffic;
...
public class TrafficPlugin extends Plugin {
    ...
    public void start() {
        ...
        nativeInitTraceHarborTraffic(trafficConfig.isRxCollectorEnable(), trafficConfig.isTxCollectorEnable(), trafficConfig.willDumpStackTrace(), trafficConfig.willDumpNativeBackTrace(), trafficConfig.willHookAllSoReadWrite(), ignoreSoFiles);
    }
    ...
    private static native void nativeInitTraceHarborTraffic(boolean rxEnable, boolean txEnable, boolean dumpStackTrace, boolean dumpNativeBackTrace, boolean willHookAllSoReadWrite, String[] ignoreSoFiles);
    private static native String nativeGetTrafficInfo();
    private static native String nativeGetAllStackTraceTrafficInfo();
    private static native void nativeReleaseTraceHarborTraffic();
    ...
    private static void setFdStackTrace(String key) {
        ...
        String md5 = TraceHarborUtil.getMD5String(stackTrace.toString());

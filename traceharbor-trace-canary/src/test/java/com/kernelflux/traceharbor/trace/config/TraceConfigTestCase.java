...
public class TraceConfigTestCase extends TestCase {
    ...
    public void testSetSplashActivities() {
        final String splashActivities = "com.kernelflux.traceharbor.SplashActivity1;com.kernelflux.traceharbor.SplashActivity2";
        // 设置
        TraceConfig config = new TraceConfig.Builder().dynamicConfig(new MockDynamicConfig() {
            @Override
            public String get(String key, String defStr) {
                if ( IDynamicConfig.ExptEnum.clicfg_traceharbor_trace_care_scene_set.name().equalsIgnoreCase(key) ) {
        ...
        assertTrue( activities.contains("com.kernelflux.traceharbor.SplashActivity1"));
        assertTrue( activities.contains("com.kernelflux.traceharbor.SplashActivity2"));
    }
    ...
    public void testOneSplashActivity() {
        final String splashActivities = "com.kernelflux.traceharbor.SplashActivity1";
        TraceConfig config = new TraceConfig.Builder().build() ;
        // 设置 splashActivities
        config.splashActivities = splashActivities ;
        ...
        assertTrue( activities.contains("com.kernelflux.traceharbor.SplashActivity1"));
        assertFalse( activities.contains("com.kernelflux.traceharbor.SplashActivity2"));
    }

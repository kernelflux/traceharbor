...
public class TraceConfigTestCase extends TestCase {
    ...
    public void testSetSplashActivities() {
        final String splashActivities = "io.traceharbor.SplashActivity1;io.traceharbor.SplashActivity2";
        // 设置
        ...
        assertTrue( activities.contains("io.traceharbor.SplashActivity1"));
        assertTrue( activities.contains("io.traceharbor.SplashActivity2"));
    }
    ...
    public void testOneSplashActivity() {
        final String splashActivities = "io.traceharbor.SplashActivity1";
        TraceConfig config = new TraceConfig.Builder().build() ;
        // 设置 splashActivities
        config.splashActivities = splashActivities ;
        ...
        assertTrue( activities.contains("io.traceharbor.SplashActivity1"));
        assertFalse( activities.contains("io.traceharbor.SplashActivity2"));
    }

    ...
    companion object {
        ...
        fun syncStates(supervisorToken: ProcessToken, scene: String) {
            ...
            dispatchOwners.forEach {
                ...
                TraceHarborLog.i(ProcessSupervisor.tag, "syncStates: ${it.key} $active")
        ...
        fun attach(application: Application) {
            dispatchOwners.forEach {
                it.value.apply {
                    ...
                    attachedObserver = object : IStateObserver, ISerialObserver {
                        override fun on() {
                            TraceHarborLog.d(ProcessSupervisor.tag, "attached ${it.key} turned ON")
                        ...
                        override fun off() {
                            TraceHarborLog.d(ProcessSupervisor.tag, "attached ${it.key} turned OFF")
                            safeApply("${ProcessSupervisor.tag}.${it.key}") {
                                ProcessSupervisor.supervisorProxy?.onStateChanged(
            ...
            TraceHarborLog.i(ProcessSupervisor.tag, "DispatcherStateOwners attached")
        }
        ...
        fun detach() {
            ...
            TraceHarborLog.i(ProcessSupervisor.tag, "DispatcherStateOwners detached")
        }

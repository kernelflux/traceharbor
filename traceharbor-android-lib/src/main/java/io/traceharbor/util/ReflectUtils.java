...
public class ReflectUtils {
    private final static String TAG = "TraceHarbor.ReflectUtils";
    ...
    public static <T> T reflectObject(Object instance, String name, T defaultValue, boolean isHard) {
        ...
        if (isHard) {
            try {
                ...
                TraceHarborLog.e(TAG, e.toString() + "isHard=%s\n%s", true, TraceHarborUtil.printException(e));
            }
        } else {
            try {
                ...
                TraceHarborLog.e(TAG, e.toString() + "isHard=%s\n%s", false, TraceHarborUtil.printException(e));
            }
        }
        return defaultValue;
    }

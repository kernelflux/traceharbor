package io.traceharbor.iocanary.detect;
...
public final class TraceHarborCloseGuard {
    private static final String TAG = "TraceHarbor.CloseGuard";

    /**
     * Instance used when CloseGuard is disabled to avoid allocation.
     */
    private static final TraceHarborCloseGuard NOOP = new TraceHarborCloseGuard();
     ...
     */
    public static TraceHarborCloseGuard get() {
        if (!sENABLED) {
            return NOOP;
        }
        return new TraceHarborCloseGuard();
    }
    ...
    private static final class DefaultReporter implements Reporter {
        ...
        public void report(String message, Throwable allocationSite) {
            TraceHarborLog.e(TAG, message, allocationSite);
        }
    }
}
